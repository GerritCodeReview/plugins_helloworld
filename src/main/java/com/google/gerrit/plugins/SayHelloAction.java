...
class SayHelloAction implements UiAction<RevisionResource>,
  ...
  public UiAction.Description getDescription(RevisionResource resource) {
    return new UiAction.Description().setLabel("Say-hello")
        .setTitle("Say hello in different languages").setVisible(true);
  }
}
